...
class WBlockElementZapper {
  ...
  initializeUI() {
    ...
    if (!this.toolbar || !this.pickerPanel) {
      console.error("Syferlab Zapper: UI elements not found");
      return;
    }

    // Bind UI events
    document
      .getElementById("quit-zapper")
      .addEventListener("click", () => this.quit());
    document
      .getElementById("toggle-picker")
      .addEventListener("click", () => this.togglePicker());
    document
      .getElementById("preview-btn")
      .addEventListener("click", () => this.togglePreview());
    document
      .getElementById("create-rule-btn")
      .addEventListener("click", () => this.createRule());
  ...
  quit() {
    ...
    if (
      ...
      window.webkit.messageHandlers.zapperController
    ) {
  ...
  shouldIgnoreElement(element) {
    ...
    if (
      element.closest("#wblock-zapper-toolbar") ||
